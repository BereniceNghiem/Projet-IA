#!/bin/bash
#SBATCH --job-name=comi_train            # Name of your job
#SBATCH --output=comi_train_%j.out            # Output file (%x for job name, %j for job ID)
#SBATCH --error=comi_train_%j.err             # Error file
