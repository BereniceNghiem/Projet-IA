...
def load_confocal(input_shape=None, set=None, z_depth=None):
    ...
    dir = '/home/ids/bnghiem-23/Projet-IA-Telecom-Paris/Dataset/BPAEC/actin/' + set
    lr_lq_set = []
    hr_lq_set = []
    lr_hq_set = []
    hr_hq_set = []
...
class StarGAN(object):
    ...
    def build_vgg_hr(self, name=None):
        ...
        vgg = VGG19(include_top=False, weights="/home/ids/bnghiem-23/Projet-IA-Telecom-Paris/COMI/vgg19_weights_tf_dim_ordering_tf_kernels_notop.h5")
    ...
    def train(self, model, epochs, batch_size, sample_interval, set=None, z_depth=None):
        ...
        for epoch in range(epochs):
            ...
            img_lq_id = self.generator_hq2lq.predict(imgs_hrlq_train, batch_size=1)
            g_loss_hq = self.combined_hq_m.train_on_batch([imgs_hrlq_train, imgs_hrhq_train],
                                                  [valid_hr, valid_hr,
                                                   image_features_hq,
                                                   image_features_lq,
            ...
            img_hq_id = self.generator_lq2hq.predict(imgs_hrhq_train, batch_size=1)
            g_loss_lq = self.combined_lq_m.train_on_batch([imgs_hrlq_train, imgs_hrhq_train],
                                                  [valid_hr, valid_hr,
                                                  image_features_lq,
                                                  image_features_hq,
