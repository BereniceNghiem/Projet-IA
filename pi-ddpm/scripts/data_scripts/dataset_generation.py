...
def generate_w2s_dataset(base_path, p_size=256):
    ...
    np.savez('/home/ids/bnghiem-23/Projet-IA-Telecom-Paris/pi-ddpm/data/w2s_test.npz', x=XTrain, y=YTrain)

generate_biosr_dataset('/home/ids/bnghiem-23/Projet-IA-Telecom-Paris/pi-ddpm/data')
...
#generate_training_set(n_samples, n_batches, sample_shape, kernel_shape, paths='/home/ids/bnghiem-23/Projet-IA-Telecom-Paris/pi-ddpm/')
